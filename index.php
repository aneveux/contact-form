    ...
    <body>
            ...
            <div id="content">
                    ...
                    <form action="./index.php" method="post" autocomplete="on" class="secure">
                            ...
                            <p>
                                    <label for="type" class="iconic quote-alt"> Purpose </label>
                                    <select name="purpose" id="purpose" required>
                                    <option value="" selected>Choose the Option</option>
                                    <option value="Want to know about my work">Want to know about my work</option>
                                    <option value="Want to extend social network">Want to extend social network</option>
                                    </select>
                            </p>
